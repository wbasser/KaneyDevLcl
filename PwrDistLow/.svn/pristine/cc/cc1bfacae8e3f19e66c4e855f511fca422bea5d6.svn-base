...
ASCCMD_BUFFER( DbgChar, DBGASCCMDHANDLER_RCVBUF_SIZE, DBGASCCOMMANDHANDLER_NUM_ARGS );
...
const CODE  ASCCMDDEF   g_atAscCmdDefs[ ASCCMD_ENUM_MAX ] =
{
  ...
  ASCCMD_DEF( DBGASCCMDHANDLER_RCVBUF_SIZE, DBGASCCOMMANDHANDLER_NUM_ARGS, DbgChar, ON, DBGASCCOMMANDHANDLER_PROMPT_CHAR, DBGASCCOMMANDHANDLER_EOL_CHAR, DbgAscCommandHandler_Write, g_szDbgAscCommandHandlerDelims, g_atDbgAscCommandHandlerTable ),
};

...
const CODE LEDDEF  g_atLedDefs[ LEDMANAGER_ENUM_MAX ] = 
{
  ...
  // LEDDEF_DIMMED( pwm )
  // LEDDEF_DIMMEDSPC( func, device, chan )
  LEDDEF_DIRECT( GPIO_PIN_ENUM_STSLED ),
  LEDDEF_DIMMEDSPC( LedIS31FL3195_SetIntensity, LEDIS31FL3195_DEV_ENUM_STS, LEDIS31FL3195_CHAN_ENUM_RED ),
  LEDDEF_DIMMEDSPC( LedIS31FL3195_SetIntensity, LEDIS31FL3195_DEV_ENUM_STS, LEDIS31FL3195_CHAN_ENUM_GRN ),
  LEDDEF_DIMMEDSPC( LedIS31FL3195_SetIntensity, LEDIS31FL3195_DEV_ENUM_STS, LEDIS31FL3195_CHAN_ENUM_BLU ),
  LEDDEF_DIMMEDSPC( LedIS31FL3195_SetIntensity, LEDIS31FL3195_DEV_ENUM_STS, LEDIS31FL3195_CHAN_ENUM_WHT ),
  LEDDEF_DIMMEDSPC( LedIS31FL3195_SetIntensity, LEDIS31FL3195_DEV_ENUM_USR, LEDIS31FL3195_CHAN_ENUM_RED ),
  LEDDEF_DIMMEDSPC( LedIS31FL3195_SetIntensity, LEDIS31FL3195_DEV_ENUM_USR, LEDIS31FL3195_CHAN_ENUM_GRN ),
  LEDDEF_DIMMEDSPC( LedIS31FL3195_SetIntensity, LEDIS31FL3195_DEV_ENUM_USR, LEDIS31FL3195_CHAN_ENUM_BLU ),
  LEDDEF_DIMMEDSPC( LedIS31FL3195_SetIntensity, LEDIS31FL3195_DEV_ENUM_USR, LEDIS31FL3195_CHAN_ENUM_WHT ),
};
  ...
  const CODE LEDRGBDEF  g_atLedRgbDefs[ LEDMANAGER_RGBENUM_MAX ] =
  {
    ...
    LEDMNGRRGBDEF( LEDMANAGER_ENUM_RGBSTSRED, LEDMANAGER_ENUM_RGBSTSGRN, LEDMANAGER_ENUM_RGBSTSBLU ),
    LEDMNGRRGBDEF( LEDMANAGER_ENUM_RGBUSRRED, LEDMANAGER_ENUM_RGBUSRGRN, LEDMANAGER_ENUM_RGBUSRBLU ),
  };

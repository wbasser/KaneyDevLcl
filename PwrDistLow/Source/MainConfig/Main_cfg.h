...
// macro declarations ---------------------------------------------------------
/// define the enable the system idle time cmds
#define MAIN_ENABLE_SYSTIMECMDS                 ( OFF )

/// define the macro to disable initialization
#define	MAIN_DISABLE_INITILIZATION		( OFF )
...
extern  void  Main_LocalFaultInitialize( void );

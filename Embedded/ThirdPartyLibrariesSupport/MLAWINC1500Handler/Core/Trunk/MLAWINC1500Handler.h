...
/// define the DNS resolved callback function
typedef void  ( *PVDSNCALLBACK )( U32 uIpAddr );
...
extern  void            MLAWINC1500Handler_GetHostByName( PC8 pszHostName, PVDSNCALLBACK pvDnsCallback );

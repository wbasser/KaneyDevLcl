 ...
 *
 *****************************************************************************/
BOOL SpecialCommands_Initialize(void )
{
...
static void	CmdTerminate(void )
{
  ...
  DALIMessageHandler_StopInitTimer(  );
...
static void	CmdInitialize(void )
{
      ...
      ( g_ptDaliCtl->tCurMessage.tFields.nData == (( g_ptDaliCtl->tDaliPrm.nShortAddress << 1 ) | 0x01 )))
  {
    ...
    DALIMessageHandler_StartInitTimer( );
...
static void	CmdRandomize(void )
{
  ...
  // update NVM
  DALIMessageHandler_PutValue( DALI_PARAM_RANDOM_ADDR_H, g_ptDaliCtl->tDaliPrm.tRandomAddr.anValue[ RANDOM_ADDR_H ], FALSE );
  DALIMessageHandler_PutValue( DALI_PARAM_RANDOM_ADDR_M, g_ptDaliCtl->tDaliPrm.tRandomAddr.anValue[ RANDOM_ADDR_M ], FALSE );
  DALIMessageHandler_PutValue( DALI_PARAM_RANDOM_ADDR_L, g_ptDaliCtl->tDaliPrm.tRandomAddr.anValue[ RANDOM_ADDR_L ], FALSE );
}

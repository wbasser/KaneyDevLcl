...
/// define the reponse handler for master messsages
typedef void ( *PVRSPHANDLER )( BINPROTDYNSTS );
...
extern  void            BinaryProtocolDynamic_SendMessage( PVRSPHANDLER pvRspHandler );

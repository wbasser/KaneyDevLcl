...
{
  BINPROTDYNRSP eStatus;

  // process the character
  eCurStatus = ProcessProtocol( nChar );

  // check for a master
  if ( tConfig.bMasterMode == FALSE )
  {
  ...
  {
    // call the callback
    if ( tConfig.pvRspHandler != NULL )
    {
      // call it
      tConfig.pvRspHandler( eCurStatus );
    }
  }
...
/******************************************************************************
 * @function BinaryProtocolDynamic_SendMessage
 *
 * @brief send a message
 *
 * This function will send a message
 *
 * @param[in]   pvRspHandler  pointer to the response handler
 *
 *****************************************************************************/
void BinaryProtocolDynamic_SendMessage( PVRSPHANDLER pvRspHandler )
{
  // set the response handler
  tConfig.pvRspHandler = pvRspHandler;

...
extern  BOOL  LedHT16K33Handler_Initialize( void );
...
extern  void  LedHT16K33Handler_DisplayColon( U8 nDeviceID, BOOL bDisplayColon, BOOL bUpdEnable );
extern  void  LedHT16K33Handler_DisplayChar( U8 nDeviceID, U8 nDigit, U8 nCharacter, BOOL bDecimal, BOOL bUpdEnable );

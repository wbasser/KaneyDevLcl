...
const C8	g_szFormAct[ ] 	= { "<form method=\"%s\" >" };
...
const C8	g_szMetaCnt[ ]	= { "\" content=\"%d\"" };
...
const C8	g_szPageSty[ ] 	= { " style=\"MARGIN: 1em auto; FONT: 8px arial,sans-serif; TEXT-ALIGN: %s\"" };
...
const C8  g_szSvgBegn[ ]  = { "<svg width=\"%d\" height=\"%d\">" };
const C8  g_szSvgRect[ ]  = { "<rect width=\"%d\" height=\"%d\" style=\"fill:#%06X;stroke-width:%d;stroke:#%06X\"/>" };
const C8  g_szSvgCirc[ ]  = { "<circle cx=\"%d\" cy=\"%d\" r=\"%d\" stroke=\"%d\" stroke-width=\"%d\" fill=\"#%06X\" />" };
const C8  g_szSvgEnds[ ]  = { "/svg>" };

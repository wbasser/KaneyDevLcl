...
typedef void ( *PVBTNMNGRCBFUNC  )( BTNENUM eBtnEnum, BTNMNGREVENTS eEvent );
...
extern  BTNENUM ButtonManagerDynamic_CreateButtonGpio( GPIOPORT ePort, U8 nPin, BOOL bReleaseEnb, BOOL bPressEnb, BOOL bRptEnb, BOOL bShortEnb, BOOL bMedEnb, BOOL bLongEnb, BOOL bTglEnb, PVBTNMNGRCBFUNC pvCallback );
extern  BTNENUM ButtonManagerDynamic_CreateButton( GPIOENUM eGpioEnum, BOOL bReleaseEnb, BOOL bPressEnb, BOOL bRptEnb, BOOL bShortEnb, BOOL bMedEnb, BOOL bLongEnb, BOOL bTglEnb, PVBTNMNGRCBFUNC pvCallback );

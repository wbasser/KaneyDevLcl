...
#define RTCMANAGER_NTP_AVAILABLE                ( OFF )
...
#define RTCMANAGER_ENABLE_DEBUG_COMMANDS        ( ON )

/// define the macro to enable rast time
#define RTCMANAGER_ENABE_FAST_TIME              ( OFF )

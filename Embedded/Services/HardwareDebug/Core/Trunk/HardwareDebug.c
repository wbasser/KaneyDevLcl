...
#endif
#if ( HARDWAREDEBUG_ENABLE_REGS == ON )
  static ASCCMDSTS CmdRegRd( U8 nCmdEnum );
  static ASCCMDSTS CmdRegWr( U8 nCmdEnum );
#endif
...
#endif
#if ( HARDWAREDEBUG_ENABLE_REGS == ON )
  static  const CODE C8 szCmdRegRd[ ]     = { "REGRD" };
  static  const CODE C8 szCmdRegWr[ ]     = { "REGWR" };
#endif
...
#endif
#if ( HARDWAREDEBUG_ENABLE_REGS == ON )
  static  const CODE C8 szRspRdReg[ ]     = { "RREGRD, REG: %04X, VAL: %02X\n\r" };
#endif
...
const CODE ASCCMDENTRY g_atHardwareDebugCommandsTable[ ] =
{
...
#endif
#if ( HARDWAREDEBUG_ENABLE_REGS == ON )
  ASCCMD_ENTRY( szCmdRegRd,   5, 2, ASCFLAG_COMPARE_GE,   SYSCTRLMNGR_LCLMODE_DIAGNOSTICS, CmdRegRd ),
  ASCCMD_ENTRY( szCmdRegWr,   5, 3, ASCFLAG_COMPARE_GE,   SYSCTRLMNGR_LCLMODE_DIAGNOSTICS, CmdRegWr ),
#endif
   ...
   *
   * This function will read a value froma a register
   *
   * @param[in]   nCmdEnum    command enumeration
   *
   * @return      appropriate status

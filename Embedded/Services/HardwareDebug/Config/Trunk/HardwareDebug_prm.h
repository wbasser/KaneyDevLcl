...
// Macros and Defines ---------------------------------------------------------
/// define the helper macro to enable debug commands
#define HARDWAREDEBUG_ENABLE_DBGCOMMANDS        ( OFF )

/// define the macro to disable/enable GPIO debug
#define HARDWAREDEBUG_ENABLE_GPIO               ( ON )

/// define the macro to disable/enable I2C debug
#define HARDWAREDEBUG_ENABLE_I2C                ( ON )

...
#if ( LOGHANDLER_ENABLE_DBGASCCOMMANDS == ON )
  extern  const CODE ASCCMDENTRY g_atLogHandlerAscCmdHandlerTable[ ];
#endif // LOGHANDLER_ENABLE_DBGASCCOMMANDS
#if ( LOGHANDLER_ENABLE_DBGBINCOMMANDS == ON )
  extern  const CODE BINCMDSLVENTRY g_atLogHandlerBinCmdHandlerTable[ ];
#endif // LOGHANDLER_ENABLE_DBGBINCOMMANDS

// global function prototypes --------------------------------------------------
extern  BOOL  LogHandler_Initialize( void );

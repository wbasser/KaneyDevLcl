 ...
 *
 *****************************************************************************/
PVUARTRHANDLE Uart_Configure( PUARTDEF ptDef )
{
  U16           wBaudRate;
 ...
 *
 *****************************************************************************/
void Uart_Write( PVUARTRHANDLE pvUart, U8 nData )
{
  SercomUsart* ptUsart;
 ...
 *
 *****************************************************************************/
BOOL Uart_Read( PVUARTRHANDLE pvUart, PU8 pnData )
{
  SercomUsart*  ptUsart;
  BOOL          bStatus;
 ...
 *
 *****************************************************************************/
BOOL Uart_CharsAvailable( PVUARTRHANDLE pvUart )
{
  SercomUsart* ptUsart;
 ...
 *
 *****************************************************************************/
void Uart_Close( PVUARTRHANDLE pvUart )
{
  SercomUsart* ptUsart;

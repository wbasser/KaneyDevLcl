 ...
 *
 *****************************************************************************/
ADCERRS Adc_ConvertChannel( ADCENUM eAdcChan, PU16 pwResult, PVADCCALLBACK pvCallback )
{
 ...
 *
 *****************************************************************************/
ADCERRS Adc_ControlEventChannel( ADCENUM eAdcChan, BOOL bState, PVADCCALLBACK pvCallback )
{
  ADCERRS eError = ADC_ERR_NONE;
  PADCDEF ptDef;

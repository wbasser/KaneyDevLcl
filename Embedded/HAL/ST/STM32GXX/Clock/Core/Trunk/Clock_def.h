...
#define CLKSYSHSINOPLLDEFM( ahbpre, apb1pre, apb2pre ) \
  .eSysClkSrc     = SYSCLK_SRC_HSI16, \
  .eAhbPrescale   = ahbpre, \
...
#define CLKAPB1ENBDEFM( tim2, tim3, tim4, tim6, tim7, crs, rtc, wdg, spi2, spi3, usart2, usart3, uart4, uart5, i2c1, i2c2, usb, fdcan, pwr, i2c3, lptim1, lpuart1 ) \
  .bTim2          = tim2, \
  .bTim3          = tim3, \
  .bTim4          = tim4, \
  .bTim6          = tim6, \
...
{
  SYSCLK_SRC_HSI16 = 1,           ///< High Speed Clock Internal / divided

...
#define HYSTERESISCONTROL_EXEC_MSECS            ( 1000 )
#define HYSTERESISCONTROL_EXEC_RATE             ( TASK_TIME_MSECS( HYSTERESISCONTROL_EXEC_MSECS ))
...
extern  void  HysteresisControl_PutSetpoint( HYSTCONTROLENUM eHystCtlEnum, HYSTCTRLARG xSetpoint );

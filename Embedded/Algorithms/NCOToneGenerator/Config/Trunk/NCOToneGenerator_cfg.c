...
#include "ToneGenerator/ToneGenerator_prv.h"
...
/******************************************************************************
 * @function ToneGenerator_Initialize 
 *
 * @brief initilization
 *
 ...
 *
 *****************************************************************************/
void ToneGenerator_Initialize( void )
{
...
/******************************************************************************
 * @function ToneGenerator_Control
 *
 ...
 *
 *****************************************************************************/
void ToneGenerator_Control( BOOL bState )
{
  // on/off
...
/******************************************************************************
 * @function ToneGenerator_SetFrequency
 *
 ...
 *
 *****************************************************************************/
void ToneGenerator_SetFrequency( U16 wFrequency  )
{
  // store the frequency
  ...
  Interrupt_Disable( );
  wCurrentStep = ( MAX_NUM_STEPS * wCurrentFreq ) / TONEGENERATOR_SAMPLE_RATE;
  Interrupt_Enable( );
}
 
/******************************************************************************
 * @function ToneGenerator_TimerCallback
 *
 ...
 *
 *****************************************************************************/
void ToneGenerator_TimerCallback( TIMERCBEVENT eEvent, TIMERCMPCAP eChan, U16 wValue )
{

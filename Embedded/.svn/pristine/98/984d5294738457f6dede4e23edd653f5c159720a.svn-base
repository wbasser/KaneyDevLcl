...
extern  BOOL    Adc_Initialize( void );
extern  void    Adc_Close( void );
extern  void    Adc_EnableCorrection( S16 sGain, S16 sOffset );
extern  ADCERRS Adc_ConvertChannel( ADCENUM eAdcChan, PU16 pwResult, PVADCCALLBACK pvCallback );
extern  ADCERRS Adc_ControlEventChannel( ADCENUM eAdcChan, BOOL bState, PVADCCALLBACK pvCallback );

...
#ifdef _SAMD11_
  extern	GPIOENUM 	Gpio_ConfigureIRQ( GPIOPORT ePort, U8 nPin, U8 nIrqNum, GPIOIRQSENSE eSense, BOOL bPullupEnable, BOOL bFilterEnable, BOOL bWakeup, BOOL bInitOn, BOOL bEvent, PVGPIOIRQCALLBACK pvCallback );
#else

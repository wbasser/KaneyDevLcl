...
// local includes -------------------------------------------------------------
#include "PhyKSZ8081RNACA/PhyKSZ8081RNACA.h"
#include "PhyKSZ8081RNACA/PhyKSZ8081RNACA_prv.h"
...
/******************************************************************************
 * @function PhyKSZ8081RNACA_Initialize
 *
 ...
 *
 *****************************************************************************/
GMACSTATUS PhyKSZ8081RNACA_Initialize( PU32 puGmacAddr, U8 nPhyAddr )
{
  ...
  // reset the phy
  PhyKSZ8081RNACA_Reset( puGmacAddr, nPhyAddr );

  // set the clock speed
  uClockFreq = Clock_GetCpuFreq( );
  PhyKSZ8081RNACA_SetMdcClock( puGmacAddr, uClockFreq );
...
/******************************************************************************
 * @function KSZ8081RNACAPhy_SetLink
 *
 ...
 *
 *****************************************************************************/
GMACSTATUS KSZ8081RNACAPhy_SetLink( PU32 puGmacAddr, U8 nPhyAddr, BOOL bApplyFlags )
{
  GMACSTATUS  eStatus = GMAC_STATUS_OK;
  ...
  KSZ8081RNACAPhy_EnableManagement( puGmacAddr, TRUE );
  
  // get the current status
  if (( eStatus = KSZ8081RNACAPhy_PhyRead( puGmacAddr, nPhyAddr, GMII_BMSR, &uStatus1 )) == GMAC_STATUS_OK )
  {
    ...
    if ( uStatus1 & GMII_LINK_STATUS )
    {
      ...
      if ( bApplyFlags )
      {
        ...
        if (( eStatus = KSZ8081RNACAPhy_PhyRead( puGmacAddr, nPhyAddr, GMII_PCR1, &uStatus2 )) == GMAC_STATUS_OK )
        {
          ...
          // set the speed
          KSZ8081RNACAPhy_SetSpeed( puGmacAddr, bSpeed );
          KSZ8081RNACAPhy_EnableFullDuplex( puGmacAddr, bSpeed );
        }
      }
    }
    else
  ...
  KSZ8081RNACAPhy_EnableManagement( puGmacAddr, FALSE );
...
/******************************************************************************
 * @function KSZ8081RNACAPhy_AutoNegotiate
 *
 ...
 *
 *****************************************************************************/
GMACSTATUS KSZ8081RNACAPhy_AutoNegotiate( PU32 puGmacAddr, U8 nPhyAddr )
{
  GMACSTATUS  eStatus = GMAC_STATUS_OK;
  ...
  while(( eStatus == GMAC_STATUS_OK ) && ( bRunFlag == TRUE ))
  {
    ...
    switch( nAutoNegIdx )
    {
      ...
      case 0 :
      case 3 :
        eStatus = KSZ8081RNACAPhy_PhyRead( puGmacAddr, nPhyAddr, GMII_BMCR, &uValue );
        nAutoNegIdx++;
        break;
      ...
      case 1 :
        ...
        uValue |= GMII_ISOLATE;
        eStatus = KSZ8081RNACAPhy_PhyWrite( puGmacAddr, nPhyAddr, GMII_BMCR, uValue );
        nAutoNegIdx++;
        break;
      ...
      case 2 :
        ...
        eStatus = KSZ8081RNACAPhy_PhyWrite( puGmacAddr, nPhyAddr, GMII_ANAR, uPhyAnar );
        nAutoNegIdx++;
        break;
      ...
      case 6 :
        ...
        eStatus = KSZ8081RNACAPhy_PhyRead( puGmacAddr, nPhyAddr, GMII_BMSR, &uValue );
      ...
      case 7 :
        eStatus = KSZ8081RNACAPhy_PhyRead( puGmacAddr, nPhyAddr, GMII_ANLPAR, &uPhyAnalPr );
        nAutoNegIdx++;
        break;
      ...
      case 8 :
        ...
        // set up speed/duplex
        KSZ8081RNACAPhy_SetSpeed( puGmacAddr, bSpeed );
        KSZ8081RNACAPhy_EnableFullDuplex( puGmacAddr, bFullDuplex );
        
        // select MII
        KSZ8081RNACAPhy_SelectMiiMode( puGmacAddr, GMAC_PHY_MII );
        
        // enabled transmit/receive
        KSZ8081RNACAPhy_EnableTransmit( puGmacAddr, TRUE );
        KSZ8081RNACAPhy_EnableReceive( puGmacAddr, TRUE );
...
/******************************************************************************
 * @function KSZ8081RNACAPhy_Reset
 *
 * @brief reset the PHY
 *
 ...
 *
 *****************************************************************************/
GMACSTATUS KSZ8081RNACAPhy_Reset( PU32 puGmacAddr, U8 nPhyAddr )
{
  U32         uBmcr;
  ...
  // reset the PHY
  uBmcr = GMII_RESET;
  KSZ8081RNACAPhy_PhyWrite( puGmacAddr, nPhyAddr, GMII_BMCR, uBmcr );
  
  // now wait till reset is set or timeout
  do
  {
    // read the control register/test for reset
    KSZ8081RNACAPhy_PhyRead( puGmacAddr, nPhyAddr, GMII_BMCR, &uBmcr );

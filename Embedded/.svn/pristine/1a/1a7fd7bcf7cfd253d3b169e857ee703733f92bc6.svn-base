...
typedef enum _CONFIGTYPE
{
  ...
  CONFIG_TYPE_WLANCONFIG = 0,
  CONFIG_TYPE_NETCMDHAND,
...
extern  BOOL  ConfigManager_LocalInitialize( void );
...
extern  void  ConfigManager_LogConfigReset( U16 wCrc, BOOL bStatus );

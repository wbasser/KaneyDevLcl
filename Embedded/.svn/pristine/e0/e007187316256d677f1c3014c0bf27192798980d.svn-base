...
#endif // CONFIGMANAGER_ENABLE_LOGEVENTS
...
const CODE CONFIGMGRBLKDEF atConfigDefs[ CONFIG_TYPE_MAX ] =
{
  ...
  CONFIGMGRVARBLKDEF( MLAWINC1500Handler_GetConfigSize, MLAWINC1500Handler_GetDefaultConfig, MLAWINC1500Handler_GetActualConfig  ),
  CONFIGMGRFIXBLKDEF( NETWORKCMDHANDCFG_SIZE,           NetworkConnectionManager_GetConfigDflt, NetworkConnectionManager_GetConfigActl ),
};
 ...
 *
 *****************************************************************************/
BOOL ConfigManager_LocalInitialize( void )
{
  #if ( SYSTEMDEFINE_OS_SELECTION == SYSTEMDEFINE_OS_FREERTOS )
...
/******************************************************************************
 * @function ConfigManager_LogConfigReset
 *
 * @brief log a configuration reset
 *
 * This function will log a configuration reset to the log
 * 
 * @param[in]   wCrc    current CRC
 * @param[in]   bStatus status of the update
 *
 *****************************************************************************/
void ConfigManager_LogConfigReset( U16 wCrc, BOOL bStatus )
{
  #if ( CONFIGMANAGER_ENABLE_LOGEVENTS == ON )

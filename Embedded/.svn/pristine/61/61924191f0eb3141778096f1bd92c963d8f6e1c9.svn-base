...
typedef enum _LEDMANAGERSELENUM
{
  ...
  LEDMANAGER_ENUM_RGBSTSRED,
  LEDMANAGER_ENUM_RGBSTSGRN,
  LEDMANAGER_ENUM_RGBSTSBLU,
  LEDMANAGER_ENUM_RGBSTSWHT,
  LEDMANAGER_ENUM_RGBUSRRED,
  LEDMANAGER_ENUM_RGBUSRGRN,
  LEDMANAGER_ENUM_RGBUSRBLU,
  LEDMANAGER_ENUM_RGBUSRWHT,
  ...
  typedef enum _LEDMANAGERRGBENUM
  {
    ...
    LEDMANAGER_RGBENUM_STS = 0,
    LEDMANAGER_RGBENUM_USR,

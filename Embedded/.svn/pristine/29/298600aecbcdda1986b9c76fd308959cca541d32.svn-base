...
typedef void ( *PVGPIOIRQCALLBACK )( U8 nIrq, U8 nPinState );

// global parameter declarations -----------------------------------------------

// global function prototypes --------------------------------------------------
extern  GPIOPINENUM Gpio_ConfigurePin( GPIOPORT ePort, U8 nPin, GPIODIR eDir, GPIOMODE eMode, BOOL bInvert, BOOL bInitial, PVGPIOIRQCALLBACK pvCallback );
...
extern  GPIOERR     Gpio_SetDir( GPIOPINENUM eEnum, GPIODIR eDir );

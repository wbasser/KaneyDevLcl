...
I2CERROR I2c_Read( I2CDEVENUM eDev, PI2CXFRCTL ptXfrCtl )
{
  ...
  if ( eDev < I2C_DEV_ENUM_MAX )
  {
    ...
    if ( ptCtl->bOkay )
    {
      ...
      if ( i2c_write_read( ptCtl->ptI2c, ptXfrCtl->nDevAddr, ( PC8 )&ptXfrCtl->tAddress, ptXfrCtl->nAddrLen, ptXfrCtl->pnData, ptXfrCtl->wDataLen ) != 0 )
      {
        // set the error
        eError = I2C_ERROR_TIMEOUT;
      }

...
extern  const CODE HYSTCONTROLDEF g_atHystControlDefs[ ];

// global function prototypes --------------------------------------------------
extern  BOOL          HysteresisControl_LocalInitialize( void );
extern  HYSTCTRLARG   HysteresisControl_GetProcessValue( U8 nSensorEnum );
extern  void          HysteresisControl_SetControlState( U8 nControlEnum, BOOL bControlState );

...
#define CLOCKMUXDEFM( id, clkgenid, writelock ) \
  { \
    .eMuxId = id, \
...
#define CLOCKXOSCDEFM( oscsel, xtlfrq, ondemand, cfdpre, startdly, imult, iref, runstby, xtalenb, cfdswb, cfdenb, loopenb, lbgenb ) \
  { \
    .eOscSel = oscsel, \
    .tOscs = \
    { \
      ...
      { \
        ...
        .eStartup = startdly, \
        .nOscIMultiplier = imult, \
        .nOscIReference = iref, \
        .uXtalFrequency = xtlfrq, \
      }, \
    }, \
  }
...
{
  CLOCK_MUXID_DFLL48M_REF = 0,  ///< 00 - DFLL48M reference
  CLOCK_MUXID_FDPLL0,           ///< 01 - DFLL0 reference
  CLOCK_MUXID_FDPLL1,           ///< 02 - DFLL1 reference
  CLOCK_MUXID_SLOWCLOCK,        ///< 03 - slow clock reference
  CLOCK_MUXID_EIC,              ///< 04 - external interrupt controller
  CLOCK_MUXID_FREQMSR,          ///< 05 - freuqncy measure
  CLOCK_MUXID_FREQREF,          ///< 06 - frequency reference
  CLOCK_MUXID_SERCOM_0,         ///< 07 - SERCOM 0 
  CLOCK_MUXID_SERCOM_1,         ///, 08 - SERCOM 1 
  CLOCK_MUXID_TC01,             ///< 09 - TC 0
  CLOCK_MUXID_USB,              ///< 10 - USB
  CLOCK_MUXID_EVSYSCH0,         ///< 11 -  event system channel 0
  CLOCK_MUXID_EVSYSCH1,         ///< 12 -  event system channel 1
  CLOCK_MUXID_EVSYSCH2,         ///< 13 -  event system channel 2
  CLOCK_MUXID_EVSYSCH3,         ///< 14 -  event system channel 3
  CLOCK_MUXID_EVSYSCH4,         ///< 15 -  event system channel 4
  CLOCK_MUXID_EVSYSCH5,         ///< 16 -  event system channel 5
  CLOCK_MUXID_EVSYSCH6,         ///< 17 -  event system channel 6
  CLOCK_MUXID_EVSYSCH7,         ///< 18 -  event system channel 7
  CLOCK_MUXID_EVSYSCH8,         ///< 19 -  event system channel 8
  CLOCK_MUXID_EVSYSCH9,         ///< 20 -  event system channel 9
  CLOCK_MUXID_EVSYSCH10,        ///< 21 -  event system channel 10
  CLOCK_MUXID_EVSYSCH11,        ///< 22 -  event system channel 11
  CLOCK_MUXID_SERCOM_2,         ///< 23 -  SERCOM 2 
  CLOCK_MUXID_SERCOM_3,         ///< 24 -  SERCOM 3 
  CLOCK_MUXID_TCC01,            ///< 25 -  TCC 0 and 1
  CLOCK_MUXID_TC23,             ///< 26 -  TC 2 and 3
  CLOCK_MUXID_CAN0,             ///< 27 -  CAN 0
  CLOCK_MUXID_CAN1,             ///< 28 -  CAN 1
  CLOCK_MUXID_TCC23,            ///< 29 -  TCC 2 and 3
  CLOCK_MUXID_TC45,             ///< 30 -  TC 4 and 5  
  CLOCK_MUXID_PDEC,             ///< 31 -  PDEC
  CLOCK_MUXID_AC,               ///< 32 -  AC
  CLOCK_MUXID_CCL,              ///< 33 -  CCL
  CLOCK_MUXID_SERCOM_4,         ///< 34 -  SERCOM 4 
  CLOCK_MUXID_SERCOM_5,         ///< 35 -  SERCOM 5 
  CLOCK_MUXID_SERCOM_6,         ///< 36 -  SERCOM 6 
  CLOCK_MUXID_SERCOM_7,         ///< 37 -  SERCOM 7 
  CLOCK_MUXID_TCC4,             ///< 38 -  TCC 4
  CLOCK_MUXID_TC67,             ///< 39 -  TC 6 and 7  
  CLOCK_MUXID_ADC0,             ///< 40 -  ADC0
  CLOCK_MUXID_ADC1,             ///< 41 -  ADC1
  CLOCK_MUXID_DAC,              ///< 42 -  DAC
  CLOCK_MUXID_IS20,             ///< 43 -  I2S 0
  CLOCK_MUXID_IS21,             ///< 44 -  I2S 1
  CLOCK_MUXID_SDHC0,            ///< 45 -  SCHC0
  CLOCK_MUXID_SDHC1,            ///< 46 -  SCHC`
  CLOCK_MUXID_CM4TRACE,         ///< 47 -  CM4 Trace
...
// structures -----------------------------------------------------------------
/// define the CPU divice structure
typedef struct PACKED _CLOCKMAINDEF
{
  U8                  nCpuDivide;     ///< CPU clock divide
  MCLK_AHBMASK_Type   tMclkAhb;       ///< AHB clock mask
  MCLK_APBAMASK_Type  tMclkApbA;      ///< APA clock mask
  MCLK_APBBMASK_Type  tMclkApbB;      ///< APB clock mask
  MCLK_APBCMASK_Type  tMclkApbC;      ///< APC clock mask
  MCLK_APBDMASK_Type  tMclkApbD;      ///< APD clock mask
} CLOCKMAINDEF, *PCLOCKMAINDEF;
#define CLOCKMAINDEF_SIZE                       sizeof( CLOCKMAINDEF )

/// define the clock multiplixer definition structure
typedef struct PACKED _CLOCKMUXDEF
{
...
typedef struct PACKED _CLOCKGENDEF
{
  CLOCKGENID        eId;                      ///< ID
...
typedef struct PACKED _CLOCKOSC32KDEF
{
  struct  
  {
...
typedef struct PACKED _CLOCKXOSCKDEF
{
  struct  
  {
    BOOL                bOnDemand           : 1;  ///< enable on demand operation
...
typedef struct PACKED _CLOCKDFLLDEF
{
  struct  
  {
    BOOL                bOnDemand           : 1;  ///< enable on demand operation
...
typedef struct PACKED _CLOCKOSCDEF
{
  CLOCKOSC              eOscSel;
  union
  {

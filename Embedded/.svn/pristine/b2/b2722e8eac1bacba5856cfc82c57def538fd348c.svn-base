...
extern  PVUARTHANDLE  Uart_Configure( PUARTDEF ptDef );
extern  void          Uart_Write( PVUARTHANDLE pvUart, U8 nData );
extern  BOOL          Uart_Read( PVUARTHANDLE pvUart, PU8 pnData );
extern  BOOL          Uart_CharsAvailable( PVUARTHANDLE pvUart );
extern  void          Uart_Close( PVUARTHANDLE pvUart );

...
#define GPIOIRQDEF( port, pin, sense, async, filter, callback, initon ) \
  { \
    .ePort          = port, \
    .nPin           = pin, \
    .eSense         = sense, \
...
typedef enum _GPIOFUNCMUX
{
  ...
  GPIO_FUNCMUX_I,           ///< I function
  GPIO_FUNCMUX_J,           ///< J function
  GPIO_FUNCMUX_K,           ///< K function
  GPIO_FUNCMUX_L,           ///< L function
  GPIO_FUNCMUX_M,           ///< M function
  GPIO_FUNCMUX_N,           ///< N function
  GPIO_FUNCMUX_MAX
} GPIOFUNCMUX;
...
// structures -----------------------------------------------------------------
/// define the callback
typedef void ( *PVGPIOIRQCALLBACK )( U8 nIrq, BOOL bState );

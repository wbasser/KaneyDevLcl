...
// Macros and Defines ---------------------------------------------------------
/// define the helper macro for normal mode, signle ended
#define ADCDEF_NORMSING( inpchan, refsel, prescale, gain, samplen ) \
  { \
...
/// define the helper macro for accumulated mode, single ended
#define ADCDEF_ACCUMSING( inpchan, refsel, prescale, gain, samplen, numsamps ) \
{ \
...
/// define the helper macro for aVerage mode, single ended
#define ADCDEF_AVRGSING( inpchan, refsel, prescale, gain, samplen, numsamps ) \
{ \
...
/// define the helper macro for normal mode, differential input
#define ADCDEF_NORMDIFF( inpchan, innchan, refsel, prescale, gain, samplen ) \
{ \
  .eMode = ADC_MODE_NORMAL, \

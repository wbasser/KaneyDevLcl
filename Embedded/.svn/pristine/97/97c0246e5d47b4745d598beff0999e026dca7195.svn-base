...
#define LEDMANAGER_RGB_LEDS_ENABLED             ( OFF )

/// define the animation rate in milliseconds 
#define LEDMANAGER_ANIMATE_RATE_MSECS           ( 25 )

/// define the scan rate in milliseconds
#define LEDMANAGER_SCAN_RATE_MSECS              ( 2 )

/// define the macro for enabling the debug commands
#define LEDMANAGER_ENABLE_DEBUG_COMMANDS        ( ON )

/// define the macro to enable dimmable LEDS
#define LEDMANAGER_ENABLE_DIMMABLE_LEDS         ( OFF )

/// define the macro to enable 7 segment LEDS
#define LEDMANAGER_7SEG_LEDS_ENABLED            ( OFF )

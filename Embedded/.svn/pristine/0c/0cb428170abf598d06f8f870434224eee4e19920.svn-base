/******************************************************************************
 * @file USBCDCHandler_def.h
 *
 * @brief USB-CDC handler definitions
 *
...
#ifndef _USBCDCHANDLER_DEF_H
#define _USBCDCHANDLER_DEF_H
...
/// define the union for string descriptor
typedef struct
{
  USBDESCHEADR  tHeader;
  W16           awString[];
} USBDESCSTRING, *PUSBDESCSTRING;
#define USBDESCSTRING_SIZE                      sizeof( USBDESCSTRING )

/**@} EOF USBCDCHandler_def.h */

#endif  // _USBCDCHANDLER_DEF_H
...
#ifndef _DALIMESSAGEHANDLER_DEF_H
#define _DALIMESSAGEHANDLER_DEF_H
...
// local includes -------------------------------------------------------------
#include "DALIMessageHandler/DALIMessageHandler_prm.h"
...
/// enumerate the message events
typedef enum _DALIMSGHANDEVENT
{
  DALIMSGHAND_EVENT_RCVDONE = 0,
  DALIMSGHAND_EVENT_RCVERR,
  DALIMSGHAND_EVENT_TIMEOUT,
  DALIMSGHAND_EVENT_XTMDONE,
  DALIMSGHAND_EVENT_MAX
} DALIMSGHANDEVENT;

/// enumerate the configuration status
typedef enum _DALIMSGHANDCFGSTS
{
  DALIMSGHAND_CFGSTS_NOTCFGD = 0,
  DALIMSGHAND_CFGSTS_INPROGRESS,
  DALIMSGHAND_CFGSTS_CONFIGURED,
  DALIMSGHAND_CFGSTS_MAX
} DALIMSGHANDCFGSTS;
...
/**@} EOF DALIMessageHandler_def.h */

#endif  // _DALIMESSAGEHANDLER_DEF_H
